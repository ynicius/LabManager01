...
public class model_tableConvenios extends AbstractTableModel {
	private ArrayList<Object[]> linhas = new ArrayList<>();
	private String[] colunas;
	private Statement stmt;
	private String query = "select id_convenios as 'CODIGO', nomeConvenio as 'CONVÊNIO', nomeTabela as 'TABELA DE COBRANCA', cobertura as 'COBERTURA(%)' from db_labManager.convenios";
	...
	public model_tableConvenios(String query) {
